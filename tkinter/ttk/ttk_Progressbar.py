...
class ExampleApp( tk.Frame ):
  def __init__(self, *args, **kwargs):
    ...
    f2 = ttk.Frame(self)
    self.cb_one = ttk.Checkbutton(f2, text="Option 1", variable=self.var1, onvalue=1, offvalue=0)
    self.cb_two = ttk.Checkbutton(f2, text="Option 2", variable=self.var2, onvalue=1, offvalue=0)
    self.cb_one.grid()
    self.cb_two.grid()
