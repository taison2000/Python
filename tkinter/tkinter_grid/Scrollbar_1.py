...
class DpWin(object):
  def run(self):
    ...
    # Vertical
    yScrollBar = Scrollbar(f) # "orient"" default to "VERTICAL"?
    ...
    ## What does the Scrollbar scroll?
    xScrollBar.config( command=text.xview ) # This scrollbar will affect the horizontal view of text box
